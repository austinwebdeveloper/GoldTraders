...
this.setState({
 ...
 fetch('https://goldtrader.cash/rest/future.php')
  ...
  renderRow(rowData,sectionID) {
    ...
    console.log("Image:"+'https://goldtrader.cash/public/uploaded_files/products/thumb5'+rowData.product_image)
    return(
          ...
          <View style={{height:windowSize.width/2+10,marginRight:20,width:windowSize.width/2-20,backgroundColor:'white'}}>
            <View style={{height:windowSize.width/2-20,marginRight:20,width:windowSize.width/2-20,backgroundColor:'white'}}>
              <View style={{flex:1,alignItems:'center'}}>
                ...
                <Text style={{fontSize:15,marginTop:5,color:'black',fontWeight:'bold'}}>Seats Available</Text>
                <Text style={{fontSize:15,marginTop:5,color:'#F3CB13',fontWeight:'bold'}}>Seat Bids: {rowData.seat_bids}</Text>
                <Text style={{fontSize:15,marginTop:5,color:'#0AA511',fontWeight:'bold'}}>Coming Soon</Text>
              </View>
            </View>
            <View style={{height:30,width:windowSize.width/2-20,backgroundColor:'#ffb714'}}>
              <View style={{flex:1,justifyContent:'center',alignItems:'center'}}>
                <TouchableOpacity style={{height:30,width:windowSize.width/2-20,backgroundColor:'#ffb714'}}>
                  <View style={{flex:1,justifyContent:'center',alignItems:'center'}}>
                    <Text style={{fontSize:18,fontWeight:'bold',color:'white'}}>Buy Seats</Text>
                  </View>
                </TouchableOpacity>
              </View>
            </View>
          ...
          <View style={{height:windowSize.height,width:windowSize.width}}>
            <View style={{height:40,width:windowSize.width}}>
              <View style={{flex:1,backgroundColor:'#ffb714'}}>
                <View style={{flex:1,justifyContent:'center',alignItems:'center'}}>
                  <Text style={{fontSize:20,color:'black'}}>MAIN FUTURE AUCTION</Text>
                </View>
              </View>
            </View>
